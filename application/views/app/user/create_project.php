<div class="portlet light portlet-no-bg" style="padding-bottom:0;">
    <div class="portlet-title">
        <div class="caption search-results-caption">
            <span class="caption-subject text">Create New Project</span>
            <div class="margin-top-20"></div>
            <i style="font-size:15px;"><i class="bold">&euro;<?=CREATE_PROJECT_COST?></i> for <?=CREATE_PROJECT_MAX_DAYS?> days</i>
        </div>
    </div>
</div>
                ...
                <div class="tabbable-line">
                    ...
                    <div class="tab-content bs-edit-pages">
                        <div class="tab-pane active" id="tab_15_1">
                            ...
                            <form id="create-project-form" class="update-details-form bs-update-pic-form" enctype="multipart/form-data" action="/ajax/account/create_opportunity">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    <input id="qualifications" name="qualifications" type="text" class="form-control" placeholder="<?=$is_french_user ? 'Besoin de? ex: Investisseurs, Collaborateurs, partenaires etc.':'Seeking? e.g: Investors, collaborators, partners etc.' ?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
