<div class="portlet light portlet-no-bg" style="padding-bottom:0;">
    <div class="portlet-title">
        <div class="caption search-results-caption">
            <span class="caption-subject text">Edit Project</span>
                ...
                <div class="tabbable-line">
                    ...
                    <div class="tab-content bs-edit-pages">
                        <div class="tab-pane active" id="tab_15_1">
                            ...
                            <form class="update-details-form bs-update-pic-form form-ajax" enctype="multipart/form-data" action="/ajax/account/update_project">
                                <div class="form-body">
