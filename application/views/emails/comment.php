...
<a href="<?=base_url()?>page/profile/<?=$email_data['sender_id']?>" style="color:#391C4A;text-decoration:none;"><span><?=$email_data['sender_fullname']?></span></a> wrote a comment on your post.
<br><br>

Comment:<br> <span style="font-style: italic;font-size: 12px;font-weight:bold;"><?=$email_data['comment']?></span><br><br><br>
